...
const nav = [
  {href:'/support',labelKey:'supportHome',icon:HeartHandshake}, {href:'/chat',labelKey:'conversation',icon:MessageCircle},
  {href:'/mood',labelKey:'mood',icon:MoonStar}, {href:'/journal',labelKey:'journal',icon:BookOpenText},
  {href:'/exercises',labelKey:'exercises',icon:Leaf}, {href:'/wellbeing',labelKey:'wellbeing',icon:Sparkles},
